...
;; Android settings and modifiers
...
(use-package org
  ...
  (setq org-babel-load-languages
        '((python . t) (shell . t) (java . t) (sql . t) (sqlite . t) (lisp . t)))
...
(use-package yaml-ts-mode
  :ensure nil
  :preface
  (defun my/yaml-ts-outdent ()
    ""
    (interactive)
    (let ((deactivate-mark nil)
          (shift-amt (- tab-width)))
      (if (use-region-p)
          (indent-rigidly (region-beginning) (region-end) shift-amt)
        (indent-rigidly (line-beginning-position) (line-end-position) shift-amt))))

  (defun my/yaml-ts-indent ()
    ""
    (interactive)
    (let ((deactivate-mark nil)
          (shift-amt tab-width))
  ...
  :bind (:map yaml-ts-mode-map
              ("<backtab>" . my/yaml-ts-outdent)
              ("<tab>"     . my/yaml-ts-indent)
              ("TAB"       . my/yaml-ts-indent))
