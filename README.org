...
* Bootstrap & Settings
Here we configure the package archives, macOS modifiers, and core system utilities.
...
* Core UX & Editing
Fundamental behavior, keyboard shortcuts, and simple editing modes.
...
* UI, Themes
Catppuccin theme, Doom modeline, icons, visual enhancements, and help.
...
* Completion Stack
Vertico minibuffer completions and Corfu in-buffer completions.
...
* File Management
Dired file explorer and Dirvish overrides.
...
* Project & Git
Project management, Magit version control, diff highlighting, rg, and smerge helper hydras.
...
* Shells & Terminals
Terminal emulators inside Emacs: Eshell syntax highlighting, prompt customisation, and vterm.
...
* Org-Mode
Org-mode ecosystem, Agenda, habits, presentation, restclient integration, and Org-Babel formats.
...
* Development
LSP config (Eglot), compiler, formatting (Apheleia), major modes, and development helpers.
...
* Auto-tangle on Save
This hook ensures that whenever we save this =README.org= file, it automatically tangles the code blocks to =config.el=.

#+begin_src elisp
(defun my/org-babel-tangle-config ()
  (when (string-equal (buffer-file-name) (expand-file-name "README.org" user-emacs-directory))
